...
export declare type InnerArrayOperators<V> = V extends Date ? NumberOperators<V> : V extends number ? NumberOperators<V> : V extends string ? StringOperators<V> : AnyFieldOperators<V>;
...
export declare type ArrayOperators<V> = TotalArrayOperators<V> & InnerArrayOperators<V>;
...
export declare type FieldLevelQueryOperators<V> = V extends Array<any> ? ArrayOperators<V[0]> : V extends Date ? NumberOperators<V> : V extends number ? NumberOperators<V> : V extends string ? StringOperators<V> : AnyFieldOperators<V>;
export declare type SchemaKeyFilters<S> = Partial<{
    [key in Keys<S>]: FieldLevelQueryOperators<S[key]> | S[key];
}>;
export declare type Filter<S> = SchemaKeyFilters<S> | TopLevelQueryOperators<S>;
export declare type SchemaKeySort<S> = Partial<{
    [key in Keys<S>]: -1 | 1;
} & {
    $deep: {
        [key: string]: -1 | 1;
...
export declare type SchemaKeyProjection<S> = Partial<{
    [key in Keys<S>]: 0 | 1;
} & {
    $deep: {
        [key: string]: 0 | 1;
