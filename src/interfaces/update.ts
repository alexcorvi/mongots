...
export interface UpdateOperators<Schema> {
	...
	*/
	$currentDate?: UpdateOperatorsOnSchema<Schema, boolean | { $type: 'timestamp' | 'date' }>;
	/**
	 * Adds elements to an array only if they do not already exist in the set.
	 * { $addToSet: { <field1>: <value1>, ... } }
	*/
	$addToSet?: UpdateOperatorsOnSchema<Schema, Array<any> | UpdateOperatorsModifiers<Schema>>;
	/**
	...
	*/
	 ...
	 * { $push: { <field1>: <value1>, ... } }
	*/
	$push?: UpdateOperatorsOnSchema<Schema, UpdateOperatorsModifiers<Schema> | {}>;
}

export type UpdateOperatorsOnSchema<Schema, Value> = Partial<{ [key in Keys<Schema>]: Value }>;
